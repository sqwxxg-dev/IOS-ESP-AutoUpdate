...
// ========== ФУНКЦИИ РИСОВАНИЯ (CGContextRef) ==========
...
void DrawESPSkeleton(CGContextRef context, void* camera, void* gameObject, Vector3 cameraPosition, float distanceToCamera) {
    // Пустая реализация — вся логика скелетона теперь в ImGuiDrawView.mm
    // Эта функция оставлена для совместимости, но никогда не вызывается.
}
